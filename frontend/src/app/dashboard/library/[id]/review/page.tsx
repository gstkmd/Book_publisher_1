            ...
            <div className="bg-white border-b sticky top-0 z-10 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-black text-gray-900 tracking-tight">Review Mode</h1>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            ...
                            className="text-xs font-black uppercase tracking-widest px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 hover:scale-105 active:scale-95"
                        >
                            Edit Content
                        </Link>
                    </div>
