        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Content Library */}
                    <Link href="/dashboard/library" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">📚 Content Library</h2>
                        <p className="text-gray-600">Browse and manage educational content</p>
                    </Link>

                    {/* Standards */}
                    <Link href="/dashboard/standards" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {/* Lesson Plans */}
                    <Link href="/dashboard/lesson-plans" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {/* Assessments */}
                    <Link href="/dashboard/assessments" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {/* Workflow */}
                    <Link href="/dashboard/workflow" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {/* Tasks */}
                    <Link href="/dashboard/tasks" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">📌 Tasks</h2>
                        <p className="text-gray-600">View and manage your tasks</p>
                    </Link>

                    {/* Rights Management */}
                    <Link href="/dashboard/rights" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {/* Settings */}
                    <Link href="/dashboard/settings" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    ...
                    {user.role === 'admin' && (
                        <Link href="/dashboard/admin" className="block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow border-2 border-purple-200">
