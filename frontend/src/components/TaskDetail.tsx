                ...
                <div className="flex-1 overflow-y-auto border-r border-gray-100 flex flex-col bg-white">
                    ...
                    <div className="p-6 border-b border-gray-50 flex items-center justify-between sticky top-0 bg-white z-10">
                        <div className="flex items-center gap-4">
                            ...
                            {task.content_id && (
                                <Link
                                    href={`/dashboard/library/${task.content_id}/review`}
                                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-teal-50 text-teal-700 rounded-lg hover:bg-teal-100 transition-colors text-[10px] font-bold uppercase tracking-wider border border-teal-200"
                                >
